package com.dnb.ubo.v4.controller;
...
import com.dnb.ubo.v4.exception.ExceptionControllerAdvice;
import com.dnb.ubo.v4.jsonbeans.ApiRequest;
import com.dnb.ubo.v4.jsonbeans.ProductRequest;
import com.dnb.ubo.v4.jsonbeans.TransactionInfo;
...
@WebAppConfiguration
@ComponentScan(basePackages = "com.dnb.ubo.v4")
public class ControllerTest {
    ...
    public void getOwnerShipStructure() throws Exception {
        RequestBuilder requestBuilder = MockMvcRequestBuilders.request(HttpMethod.GET, "/v4/organizations/434503766/beneficialownershipstructure").param("transactionId", "1").param("productCode", "30636")
    ...
    public void getOwnerListBeneficieries() throws Exception {
        RequestBuilder requestBuilder = MockMvcRequestBuilders.request(HttpMethod.GET, "/v4/organizations/434503766/beneficialownershiplist").param("transactionId", "1").param("productCode", "30637");
        MvcResult result = mockMvc.perform(requestBuilder).andReturn();
        MockHttpServletResponse content = result.getResponse();
        assertEquals(String.valueOf(content.getStatus()), "200");
    }
    ...
    @Test
    public void getOwnerListBeneficierieswithDepth() throws Exception {
        RequestBuilder requestBuilder = MockMvcRequestBuilders.request(HttpMethod.GET, "/v4/organizations/434503766/beneficialownershiplist").param("transactionId", "1").param("productCode", "30637")
                        .param("depth", "2");
        MvcResult result = mockMvc.perform(requestBuilder).andReturn();
        MockHttpServletResponse content = result.getResponse();
        assertEquals(String.valueOf(content.getStatus()), "206");
    }
    @Test
    public void getOwnerListBeneficierieswithInvalidDepth() throws Exception {
        RequestBuilder requestBuilder = MockMvcRequestBuilders.request(HttpMethod.GET, "/v4/organizations/434503766/beneficialownershiplist").param("transactionId", "1").param("productCode", "30637")
                        .param("depth", "a");
        MvcResult result = mockMvc.perform(requestBuilder).andReturn();
        MockHttpServletResponse content = result.getResponse();
    ...
    public void getTargetDunsNotFound() throws Exception {
        RequestBuilder requestBuilder = MockMvcRequestBuilders.request(HttpMethod.GET, "/v4/organizations/01010/beneficialownershiplist").param("transactionId", "1").param("productCode", "30637");
        MvcResult result = mockMvc.perform(requestBuilder).andReturn();
        MockHttpServletResponse content = result.getResponse();
        assertEquals(String.valueOf(content.getStatus()), "200");
    }
    ...
    public void getListBeneficieriesInvalidDUNS() throws Exception {
        RequestBuilder requestBuilder = MockMvcRequestBuilders.request(HttpMethod.GET, "/v4/organizations/1213232323232/beneficialownershiplist").param("transactionId", "1").param("productCode", "30637");
        MvcResult result = mockMvc.perform(requestBuilder).andReturn();
        MockHttpServletResponse content = result.getResponse();
    ...
    public void getListBeneficieriesInvalidProductCode() throws Exception {
        RequestBuilder requestBuilder = MockMvcRequestBuilders.request(HttpMethod.GET, "/v4/organizations/434503766/beneficialownershiplist").param("transactionId", "1").param("productCode", "30636");
        MvcResult result = mockMvc.perform(requestBuilder).andReturn();
        MockHttpServletResponse content = result.getResponse();
        assertEquals(String.valueOf(content.getStatus()), "422");
        JsonBuilder.getExceptionBeneficiariesOperation(new ApplicationException(C.STRUCTURE, C.UB014));
    ...
    public void getOwnerShipInvalidDUNS() throws Exception {
        RequestBuilder requestBuilder = MockMvcRequestBuilders.request(HttpMethod.GET, "/v4/organizations/1213232323232/beneficialownershipstructure").param("transactionId", "1").param("productCode", "30636");
        MvcResult result = mockMvc.perform(requestBuilder).andReturn();
        MockHttpServletResponse content = result.getResponse();
        assertEquals(String.valueOf(content.getStatus()), "400");
        JsonBuilder.getExceptionBeneficiariesOperation(new ApplicationException(C.STRUCTURE, C.UB014));
    ...
    public void getOwnerShipSpecialCharduns() throws Exception {
        RequestBuilder requestBuilder = MockMvcRequestBuilders.request(HttpMethod.GET, "/v4/organizations/12345678*/beneficialownershipstructure").param("transactionId", "1").param("productCode", "30636")
    ...
    public void getOwnerShipInvalidownershipType() throws Exception {
        RequestBuilder requestBuilder = MockMvcRequestBuilders.request(HttpMethod.GET, "/v4/organizations/434503766/beneficialownershiplist").param("transactionId", "1").param("ownershipType", "123")
    ...
    public void getListBenefUndisclosed() throws Exception {
        RequestBuilder requestBuilder = MockMvcRequestBuilders.request(HttpMethod.GET, "/v4/organizations/434503766/beneficialownershiplist").param("transactionId", "1").param("excludeUndisclosedHoldings", "true")
                        .param("productCode", "30637");
        MvcResult result = mockMvc.perform(requestBuilder).andReturn();
        MockHttpServletResponse content = result.getResponse();
        assertEquals(String.valueOf(content.getStatus()), "200");
    ...
    public void getListBenefInvalidProductCode() throws Exception {
        RequestBuilder requestBuilder = MockMvcRequestBuilders.request(HttpMethod.GET, "/v4/organizations/434503766/beneficialownershiplist").param("transactionId", "1").param("isoAlpha2CountryCode", "AE");
        MvcResult result = mockMvc.perform(requestBuilder).andReturn();
        MockHttpServletResponse content = result.getResponse();
        assertEquals(String.valueOf(content.getStatus()), "422");
        JsonBuilder.getExceptionBeneficiariesOperation(new ApplicationException(C.SERVICE_UNAVAILABLE_TEXT, C.UB015));
    ...
    public void getListBenefInvalidTransactionId() throws Exception {
        RequestBuilder requestBuilder = MockMvcRequestBuilders.request(HttpMethod.GET, "/v4/organizations/434503766/beneficialownershiplist").param("transactionId", "").param("productCode", "30637");
        MvcResult result = mockMvc.perform(requestBuilder).andReturn();
        MockHttpServletResponse content = result.getResponse();
        assertEquals(String.valueOf(content.getStatus()), "422");
        JsonBuilder.getExceptionBeneficiariesOperation(new ApplicationException(C.SERVICE_UNAVAILABLE_TEXT, C.UB015));
    ...
    public void getOwnerShipListPost() throws Exception {
        ...
        RequestBuilder requestBuilder = MockMvcRequestBuilders.request(HttpMethod.POST, "/v4/organizations/434503766/beneficialownershiplist").contentType(APPLICATION_JSON_UTF8).content(requestJson);
        MvcResult result = mockMvc.perform(requestBuilder).andReturn();
        MockHttpServletResponse content = result.getResponse();
        assertEquals(String.valueOf(content.getStatus()), "200");
    }
    ...
    public void getOwnerShipStructurePost() throws Exception {
        ...
        // mockMvc.perform(post("/v1/organizations/434503766/beneficialownershiplist").contentType(APPLICATION_JSON_UTF8).content(requestJson)).andExpect(status().isOk());
        RequestBuilder requestBuilder = MockMvcRequestBuilders.request(HttpMethod.POST, "/v4/organizations/434503766/beneficialownershipstructure").contentType(APPLICATION_JSON_UTF8).content(requestJson);
        MvcResult result = mockMvc.perform(requestBuilder).andReturn();
        MockHttpServletResponse content = result.getResponse();
        assertEquals(String.valueOf(content.getStatus()), "200");
    }
    ...
    public void getOwnerShipStructInvalidCombination() throws Exception {
        RequestBuilder requestBuilder = MockMvcRequestBuilders.request(HttpMethod.GET, "/v4/organizations/372840736/beneficialownershipstructure").param("transactionId", "1").param("productCode", "30636")
