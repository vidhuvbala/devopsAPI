...
public class OwnershipUnavailableReason {
    ...
    public boolean equals(Object other) {
        ...
        if ((other instanceof OwnershipUnavailableReason) == false) {
            return false;
        }
        OwnershipUnavailableReason rhs = ((OwnershipUnavailableReason) other);
