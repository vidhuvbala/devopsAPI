...
public class Organization {
    ...
    @Override
    public int hashCode() {
        return new HashCodeBuilder().append(duns).append(organizationName).append(address).append(businessEntityType).append(primarySIC).append(isOutofBusiness).append(ownershipSummary).append(ownershipStructure).append(beneficiaries).append(corporateLinkage).toHashCode();
    }
