...
public class BeneficiaryAddress {
    ...
    private AddressCountry__ addressCountry;
     ...
     */
    @JsonProperty("addressCountry")
    public AddressCountry__ getAddressCountry() {
     ...
     */
    @JsonProperty("addressCountry")
    public void setAddressCountry(AddressCountry__ addressCountry) {
    ...
    public boolean equals(Object other) {
        ...
        if ((other instanceof BeneficiaryAddress) == false) {
            return false;
        }
        BeneficiaryAddress rhs = ((BeneficiaryAddress) other);
