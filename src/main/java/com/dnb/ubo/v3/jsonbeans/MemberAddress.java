...
public class MemberAddress {
    ...
    private AddressCountry_ addressCountry;
     ...
     */
    @JsonProperty("addressCountry")
    public AddressCountry_ getAddressCountry() {
     ...
     */
    @JsonProperty("addressCountry")
    public void setAddressCountry(AddressCountry_ addressCountry) {
    ...
    public boolean equals(Object other) {
        ...
        if ((other instanceof MemberAddress) == false) {
            return false;
        }
        MemberAddress rhs = ((MemberAddress) other);
