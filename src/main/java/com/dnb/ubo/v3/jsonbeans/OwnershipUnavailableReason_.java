...
public class OwnershipUnavailableReason_ {
    ...
    public boolean equals(Object other) {
        ...
        if ((other instanceof OwnershipUnavailableReason_) == false) {
            return false;
        }
        OwnershipUnavailableReason_ rhs = ((OwnershipUnavailableReason_) other);
