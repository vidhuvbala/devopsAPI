...
public class ProductRequest {
    ...
    @Override
    public int hashCode() {
        return new HashCodeBuilder().append(duns).append(isoAlpha2CountryCode).append(productCode).append(ownershipType).append(ownershipPercentage).append(includeUnknownHoldings).append(excludeUndisclosedHoldings).toHashCode();
    }
    ...
    public boolean equals(Object other) {
        ...
        if ((other instanceof ProductRequest) == false) {
            return false;
        }
        ProductRequest rhs = ((ProductRequest) other);
