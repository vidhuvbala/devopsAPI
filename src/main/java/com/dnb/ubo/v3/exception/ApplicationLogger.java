...
public class ApplicationLogger {
     ...
     * @param httpHeader
     */
    public static void logAPIDetails(final String transcationID, final String dunsNumber, final  ResponseWrapper apiResponseWrapper,final  String operationName,final  HttpHeaders httpHeader) {
        ...
        try {
            ...
            if (authorization != null && authorization.startsWith("Basic")) {
                ...
                user = credentials.split(":", C.TWO)[0];
            }
        } catch (Exception e) {
        ...
        LOGGER.info("{} {} {} {} {} {} {} {} {}", "V3", user, transcationID, dunsNumber, countryCode, operationName, round(graphTime, C.TWO), round(calculationTime, C.TWO), round(apiTime, C.TWO));
