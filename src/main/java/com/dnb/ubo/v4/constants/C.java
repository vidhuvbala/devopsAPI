...
public class C {
    ...
    public static final String  MSGFORDEPTH = "Success - Full/Partial result due to limit set on graph depth";
    ...
    public static final String INVALIDMISSINGPARAM = "Request Error - Invalid/missing request parameter";
    ...
    public static final String CONTROL_TYPE = "ctrl_typ_cd";
    public static final int STATE_OWNED_ENTERPRISE = 9059;
    public static final int GOVT_ENTITY = 32495;
    public static final int PUBLICLY_TRADED = 9057;
    public static final int PRIVATELY_OWNED = 9058;

    //Control type Confidence
    public static final String CONFIDENCE_CD = "ctrl_typ_cfdc_cd";
    public static final int HIGH = 13702;
    public static final int MEDIUM = 13698;
    public static final int LOW = 13693;
    ...
    public static final String REGEX_DEPTH = "^[1-9]\\d*$";
    ...
    public static final String MAJORITY = "HAS_MAJORITY_OWNER";
    ...
    public static final String VERSIONV4 = "Version:V4";
    ...
    public static final CharSequence INTEGER = "Integer";
    public static final String ORGBEN = "orgBen";
