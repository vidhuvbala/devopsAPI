...
public class ControlType_ {
    ...
    private Confidence_ confidence;
     ...
     */
    @JsonProperty("confidence")
    public Confidence_ getConfidence() {
        return confidence;
    }
     ...
     */
    @JsonProperty("confidence")
    public void setConfidence(Confidence_ confidence) {
    ...
    public boolean equals(Object other) {
        ...
        if ((other instanceof ControlType_) == false) {
            return false;
        }
        ControlType_ rhs = ((ControlType_) other);
