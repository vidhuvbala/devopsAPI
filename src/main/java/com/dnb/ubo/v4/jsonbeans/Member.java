...
public class Member {
    ...
    private ControlType_ controlType;
    /**
     * 
     * (Required)
     *
     ...
     */
    @JsonProperty("controlType")
    public ControlType_ getControlType() {
        return controlType;
    }
     ...
     */
    @JsonProperty("controlType")
    public void setControlType(ControlType_ controlType) {
