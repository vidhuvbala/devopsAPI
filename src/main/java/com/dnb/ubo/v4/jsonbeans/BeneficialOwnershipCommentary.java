...
public class BeneficialOwnershipCommentary {
    ...
    public boolean equals(Object other) {
        ...
        if ((other instanceof BeneficialOwnershipCommentary) == false) {
            return false;
        }
        BeneficialOwnershipCommentary rhs = ((BeneficialOwnershipCommentary) other);
