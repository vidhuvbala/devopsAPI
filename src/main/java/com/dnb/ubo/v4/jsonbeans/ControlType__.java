...
public class ControlType__ {
    ...
    private Confidence__ confidence;
     ...
     */
    @JsonProperty("confidence")
    public Confidence__ getConfidence() {
        return confidence;
    }
     ...
     */
    @JsonProperty("confidence")
    public void setConfidence(Confidence__ confidence) {
    ...
    public boolean equals(Object other) {
        ...
        if ((other instanceof ControlType__) == false) {
            return false;
        }
        ControlType__ rhs = ((ControlType__) other);
