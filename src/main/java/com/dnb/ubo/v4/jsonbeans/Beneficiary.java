...
public class Beneficiary {
    ...
    private ControlType__ controlType;
    /**
     * 
     * (Required)
     *
     ...
     */
    @JsonProperty("controlType")
    public ControlType__ getControlType() {
        return controlType;
    }
     ...
     */
    @JsonProperty("controlType")
    public void setControlType(ControlType__ controlType) {
    ...
    @Override
    public int hashCode() {
        return new HashCodeBuilder().append(memberId).append(name).append(duns).append(personId).append(beneficiaryType).append(businessEntityType).append(beneficiaryAddress).append(nationality).append(dob).append(directOwnershipPercentage).append(indirectOwnershipPercentage).append(beneficialOwnershipPercentage).append(isBeneficiary).append(ownershipUnavailableReason).append(isMinority).append(isOutofBusiness).append(controlType).append(depth).append(isUndisclosed).append(beneficialOwnershipCommentary).toHashCode();
    }
    ...
    public boolean equals(Object other) {
        ...
        return new EqualsBuilder().append(memberId, rhs.memberId).append(name, rhs.name).append(duns, rhs.duns).append(personId, rhs.personId).append(beneficiaryType, rhs.beneficiaryType).append(businessEntityType, rhs.businessEntityType).append(beneficiaryAddress, rhs.beneficiaryAddress).append(nationality, rhs.nationality).append(dob, rhs.dob).append(directOwnershipPercentage, rhs.directOwnershipPercentage).append(indirectOwnershipPercentage, rhs.indirectOwnershipPercentage).append(beneficialOwnershipPercentage, rhs.beneficialOwnershipPercentage).append(isBeneficiary, rhs.isBeneficiary).append(ownershipUnavailableReason, rhs.ownershipUnavailableReason).append(isMinority, rhs.isMinority).append(isOutofBusiness, rhs.isOutofBusiness).append(controlType, rhs.controlType).append(depth, rhs.depth).append(isUndisclosed, rhs.isUndisclosed).append(beneficialOwnershipCommentary, rhs.beneficialOwnershipCommentary).isEquals();
    }
